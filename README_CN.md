...
**🌐 [CLI-Hub](https://hkuds.github.io/CLI-Anything/hub/)**：一站式浏览和安装所有社区 CLI。有新软件的 CLI？[提交 PR](https://github.com/HKUDS/CLI-Anything/blob/main/CONTRIBUTING.md) — Hub 会即时更新。
